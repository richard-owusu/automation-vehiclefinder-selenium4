...
public class AutomationSteps {
    ...
    public void a_user_opens(String homepage) throws InterruptedException {
        driver.get(homepage);
    ...
    @When("a user enters registration {string}")
    public void a_user_enters_registration(String regNum) {
        this.regNum = regNum;
    ...
    @And("a page is displayed with vehicle information: {string} and {string}")
    public void a_page_is_displayed_with_vehicle_information_and(String make, String colour) {
    ...
    @Then("the vehicle found page is displayed with {string} and {string} information")
    public void the_vehicle_found_page_is_displayed_with_and_information(String tax, String mot) {
    ...
    public void afterStep(Scenario scenario) {
        ...
        scenario.attach(screenshot, "image/png", "screenshot-" + LocalDateTime.now());
    }
